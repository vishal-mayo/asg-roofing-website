...
function ServicesPage() {
  return (
    <>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-start">
          ...
          <div className="md:col-span-7 group">
            ...
            <p className="text-on-surface-variant mb-6 leading-relaxed max-w-xl">
              We specialise in all aspects of Mastic Asphalt roofing. We consider this method to be amongst the best and most durable of products available if laid correctly. Asphalt can be laid on flat roofs, gutters, walkways and car parks, and can also be repaired.
            </p>
            <div className="flex items-center gap-8 border-t border-outline/20 pt-6">
              <div>
                ...
                <span className="text-xl font-headline font-bold text-primary">Flat Roofs, Gutters</span>
              </div>
              <div>
            ...
            <div className="bg-surface-container-low p-8 relative">
              ...
              <div className="mt-8">
                <img
                  ...
                  src="/images/portfolio/natural-man-made-slates/asg-slate-01.avif"
            ...
            <div className="relative overflow-hidden bg-primary group">
              <div className="absolute inset-0 z-0">
                <img
                  ...
                  src="/images/portfolio/tiled-roofs/asg-tile-01.avif"
                  alt="Tiled roofing"
                />
      ...
      {/* 08 Asphalt Steps — NEW SERVICE */}
      <section className="py-24 px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <span className="text-secondary font-headline font-black text-5xl block mb-6">08</span>
              <h2 className="text-5xl font-headline font-black text-primary tracking-tighter leading-none uppercase mb-6">Asphalt<br/>Steps</h2>
              <p className="text-on-surface-variant text-lg mb-6">
                We specialise in the installation and repair of mastic asphalt steps, walkways, and access areas. Providing a durable, slip-resistant surface suitable for both residential and commercial properties.
              </p>
              <ul className="space-y-3 text-on-surface-variant">
                <li className="flex items-center gap-3">
                  <svg className="w-5 h-5 text-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="relative overflow-hidden aspect-square col-span-2">
                <img
                  className="w-full h-full object-cover"
                  src="/images/portfolio/asphalt-steps/asg-steps-01.avif"
                  alt="Mastic asphalt steps"
                />
              </div>
              <div className="relative overflow-hidden aspect-square">
                <img
                  className="w-full h-full object-cover"
                  src="/images/portfolio/asphalt-steps/asg-steps-02.png"
                  alt="Asphalt steps installation"
                />
              </div>
              <div className="relative overflow-hidden aspect-square">
                <img
                  className="w-full h-full object-cover"
                  src="/images/portfolio/asphalt-steps/asg-steps-03.png"
                  alt="Asphalt steps project"
                />
              </div>
            </div>
          </div>
      ...
      <section className="bg-surface-container-low py-24 px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <span className="text-secondary font-headline font-black text-5xl block mb-6">09</span>
            ...
            <div className="relative overflow-hidden aspect-[4/3] bg-surface-container-high flex items-center justify-center">
              <div className="text-center p-12">
                <svg className="w-16 h-16 text-primary/20 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8"/></svg>
                <p className="text-on-surface-variant text-sm">Contact us to arrange a drone survey</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row items-center relative z-10">
            ...
            <div className="w-full md:w-1/3 aspect-square relative">
              <img
                ...
                src="/images/portfolio/mastic-asphalt/asg-mastic-asphalt-02.avif"
